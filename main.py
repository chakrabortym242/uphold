...
<CameraClick>:
    ...
    Camera:
        id: camera
        pos_hint: {'center_x':.20, 'center_y':.20}
        resolution: (640, 480)
        play: False
    BoxLayout:
        ...
        Button:
            text: 'Get prediction'
            on_release: root.img_prediction() 
...
class CameraClick(BoxLayout):
    def capture(self):
        ...
        self.newvalue = np.frombuffer(self.camera.texture.pixels, np.uint8)
        self.newvalue = self.newvalue.reshape(height, width, 4)
    ...
    def img_prediction(self):
        ...
        model.compile(loss='binary_crossentropy',
              optimizer='rmsprop',
              metrics=['accuracy'])
        x=cv2.resize(self.newvalue, (224, 224))
 ...
 999: 'toilet tissue, toilet paper, bathroom tissue'}
        self.ids.updlbl.text = "It is a "+str(class_names[classes[0]])
